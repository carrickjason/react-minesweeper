        ...
        <div>
            <form onSubmit={(e)=>{
                ...
                <p>
                    <label>
                        Width:{' '}
                        <input type="number" defaultValue={width} min="1" max="20" ref={widthEl}/>
                    </label>{' '}
                    <label>
                        Height:{' '}
                        <input type="number" defaultValue={height} min="1" max="20" ref={heightEl}/>
                    </label>
                    <label>{' '}
                        Num Mines:{' '}
                        <input type="number" defaultValue={numMines} min="1" max="50" ref={numMinesEl}/>
                    </label>{' '}
